package com.example.inspirion.formulariosqlite;
        ...
        add_el.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(name.getText().toString().length()>0 && lastname.getText().toString().length()>0){
                    ...
                    email.setText("");
                    phone.setText("");
                    Toast.makeText(getBaseContext(), "Usuario Agregado!!",Toast.LENGTH_LONG).show();


                }else{
                    Toast.makeText(getBaseContext(), "Llene los campos Vacios!!",Toast.LENGTH_LONG).show();
                }
            }
        });
